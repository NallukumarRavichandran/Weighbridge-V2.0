...
/* ============================================================
   CAPTURED PHOTOS STYLING ON PRINT SLIP
   ============================================================ */
.slip-images {
    display: flex;
...
<div class="slip-container">
    ...
    <!-- CAPTURED CAMERA PHOTOS SECTION (DISPLAYS ONLY IF PHOTOS EXIST) -->
    <?php if (!empty($row['first_image_path']) || !empty($row['second_image_path'])): ?>
    <div class="divider-dashed"></div>
    <div class="slip-images">
        <?php if (!empty($row['first_image_path'])): ?>
        <div class="slip-img-box">
            <div class="img-lbl"><?= $isFinal ? 'First Weighment (Photo)' : 'Vehicle Photo' ?></div>
            <img src="<?= htmlspecialchars($row['first_image_path']) ?>" alt="Photo 1">
        </div>
        <?php endif; ?>

        <?php if (!empty($row['second_image_path'])): ?>
        <div class="slip-img-box">
            <div class="img-lbl">Second Weighment (Photo)</div>
            <img src="<?= htmlspecialchars($row['second_image_path']) ?>" alt="Photo 2">
        </div>
        <?php endif; ?>
    </div>
    <?php endif; ?>
